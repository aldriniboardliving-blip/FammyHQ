...
export default function EditFamilyModal({ visible, initialName, initialPhotoUri, onClose, onSave }: Props) {
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.overlay}>
        ...
        <View style={styles.sheet}>
          ...
          <Text style={styles.title}>Edit Family</Text>
...
const styles = StyleSheet.create({
  ...
  sheet: { backgroundColor: "#fff", borderTopLeftRadius: BorderRadius.xxl, borderTopRightRadius: BorderRadius.xxl, paddingHorizontal: 24, paddingBottom: 40, paddingTop: 12 },
  ...
  photo: { width: 96, height: 96, borderRadius: 48, backgroundColor: Colors.light.backgroundElement },
  photoPlaceholder: { width: 96, height: 96, borderRadius: 48, backgroundColor: Colors.light.backgroundElement, justifyContent: "center", alignItems: "center", borderWidth: 2, borderColor: Colors.light.border, borderStyle: "dashed" },
  photoPlaceholderText: { fontSize: 11, color: Colors.light.textTertiary, fontWeight: "600", textAlign: "center" },
  ...
  removeBtnText: { fontSize: 13, color: Colors.light.danger, fontWeight: "600" },
  label: { fontSize: 13, fontWeight: "600", color: Colors.light.textTertiary, marginBottom: 6, textTransform: "uppercase", letterSpacing: 0.5 },
  input: { backgroundColor: Colors.light.backgroundElement, borderRadius: BorderRadius.md, padding: 14, fontSize: 16, color: Colors.light.text, borderWidth: 1, borderColor: Colors.light.border, marginBottom: 24 },
